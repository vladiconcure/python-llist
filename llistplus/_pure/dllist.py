...
class dllist(object):
    ...
    def iternodes(self):
        ...
        return dllistnodeiterator(self.__first)

    def itervalues(self):
        """Iterate over list values.""" 
        return dllistiterator(self.__first)


class dllistiterator(object):
    """Iterator over dllist values."""
...
class dllistnodeiterator(object):
    """Iterator over dllist nodes."""
