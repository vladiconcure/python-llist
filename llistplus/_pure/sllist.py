...
class sllist(object):
    ...
    def iternodes(self):
        ...
        return sllistnodeiterator(self.__first)

    def itervalues(self):
        """Iterate over list values.""" 
        return sllistiterator(self.__first)


class sllistiterator(object):
    """Iterator over sllist values."""
    
    def __init__(self, first_node):
        self.__current = first_node
...
class sllistnodeiterator(object):
    """Iterator over sllist nodes."""
